...
struct StackOverflowUsersTests {
    @Test func testIntegration_UserViewModelAndService() async throws {
        ...
        var vm1 = UserViewModel.fromDataModel(user1, userFollowingService: service)
        var vm2 = UserViewModel.fromDataModel(user2, userFollowingService: service)
        ...
        var vm3 = UserViewModel.fromDataModel(user3, userFollowingService: service)
